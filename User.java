...
public class User 
{
  ...
  {
    User otherUser = (User) other; //Cast the "Object other" parameter to User object

    return (((name).equals(otherUser.getName())) && ((address).equals(otherUser.getAddress()))); //if the users have the same name and address, return true
  }
}
